...
public class Confirm extends AppCompatActivity {
                            ...
                            .addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    for(DataSnapshot detailSnapshot: dataSnapshot.getChildren()){
                                        ...
                                        CartDetailList adapter = new CartDetailList(Confirm.this, detailList);
                                        ...
                                        orderedItem.child(uid).child(categoryId).child(foodNames).setValue(orderedDetail);

                                        detailSnapshot.getRef().removeValue();

                                        Intent intent = new Intent(Confirm.this,Done.class);
    ...
    protected void onResume() {
        ...
        cartItem.child(String.format("%s",uid)).child(String.format("%s",Common.categoryId)).addListenerForSingleValueEvent(new ValueEventListener() {
