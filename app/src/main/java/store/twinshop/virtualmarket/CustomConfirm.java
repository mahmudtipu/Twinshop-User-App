...
public class CustomConfirm extends AppCompatActivity {
    ...
    int orderCount,orderC;
    OrderedDetails orderedDetail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        totalId.setText(String.valueOf("Total : Products Price + "+" Delivery charge 30tk"));
        ...
        confirmOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!emailA.isEmpty()&&!lastN.isEmpty()&&!firstN.isEmpty()&&!locationA.isEmpty()&&!mobileN.isEmpty())
                {
                    ...
                    orderedItem.child(uid).child("1").addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if (dataSnapshot.getValue()!=null)
                            {
                                for(DataSnapshot detailSnapshot: dataSnapshot.getChildren()) {
                                    orderC = Integer.parseInt(String.valueOf(detailSnapshot.getKey()));
                                }
                                        ...
                                        .addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                for(DataSnapshot detailSnapshot: dataSnapshot.getChildren()){
                                                    ...
                                                    orderedDetail = new OrderedDetails(foodNames,firstN+" "+lastN,foodQuantities,foodPrices,mobileN,locate,wsRates);

                                                    orderedItem.child(uid).child("1").child(String.valueOf(orderC)).setValue(orderedDetail);

                                                    detailSnapshot.getRef().removeValue();

                                                    Intent intent = new Intent(CustomConfirm.this,Done.class);
                                        ...
                                        .addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                for(DataSnapshot detailSnapshot: dataSnapshot.getChildren()){
                                                    ...
                                                    CartDetailList adapter = new CartDetailList(CustomConfirm.this, detailList);
